...
from network.stream.audio_stream_light import Audio_Stream_Light
...
class Audio_Net_Light(chainer.Chain):
    ...
    def __init__(self, trained=None):
        ...
        super(Audio_Net_Light, self).__init__()

        with self.init_scope():

            # ===== Audio Stream ===== #
            self.audio_stream = Audio_Stream_Light(
